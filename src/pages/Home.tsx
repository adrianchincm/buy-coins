...
const Home = (props: any) => {
  ...
  const openBuyCoinsModal = (coinSymbol: string, coinPrice: number) => {
  ...
  return (
    <div className="my-8 ">
      {!isError && !isLoading && <CoinsTable coins={data as CoinTable[]} open={openModal} setOpen={openBuyCoinsModal} />}
      ...
      <BuyCoinsModal coinSymbol={selectedCoinSymbol} coinPrice={selectedCoinPrice} open={openModal} closeModal={closeBuyCoinsModal} />
    </div>
  );
};
